...
for i = 1:n
    ...
    filename_info = sprintf("Phase_space_Bunch6d/other_info_%03d.txt", i);
    dlmwrite(filename_info, other_info, "delimiter", "\t");

    filename = sprintf("Phase_space_Bunch6d/M_%03d.txt", i);
...
save('-text', 'transport_table_3cells.txt', 'T');
