...
IBS = IntraBeamScattering(NX, NY, NZ, Ncol); % IBS definitiion
...
mkdir("Phase_space_Bunch6d_SC_IBS");
...
for i = 1:n
    ...
    other_info = [i, S_i, N_i, emitt_4d_i, emitt_z_i, mean_K_i, sigma_t_i];
    filename_info = sprintf("Phase_space_Bunch6d_SC_IBS/other_info_%03d.txt", i);
    dlmwrite(filename_info, other_info, "delimiter", "\t");

    filename = sprintf("Phase_space_Bunch6d_SC_IBS/M_%03d.txt", i);
...
save('-text', 'transport_table_3cells_SC_IBS.txt', 'T');
